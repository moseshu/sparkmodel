...
public class FenwickTreeTests {
    ...
    public void testRangeSumFenwickTree() {
        List<Data.RangeSumData<Integer>> segments = new ArrayList<Data.RangeSumData<Integer>>();
    ...
    private void testRangeSumFenwickTree(List<Data.RangeSumData<Integer>> segments) {   // Range Sum Segment tree
        FenwickTree<Data.RangeSumData<Integer>> tree = new FenwickTree<Data.RangeSumData<Integer>>(segments);
    ...
    public void testRangeSumFenwickTree2() {
        List<Data.RangeSumData<Integer>> segments = new ArrayList<Data.RangeSumData<Integer>>();
        segments.add(new Data.RangeSumData<Integer>(0,  (Integer) 2));
        segments.add(new Data.RangeSumData<Integer>(1,  (Integer) 1));
        segments.add(new Data.RangeSumData<Integer>(2,  (Integer) 1));
        segments.add(new Data.RangeSumData<Integer>(3,  (Integer) 3));
        segments.add(new Data.RangeSumData<Integer>(4,  (Integer) 2));
        segments.add(new Data.RangeSumData<Integer>(5,  (Integer) 3));
        segments.add(new Data.RangeSumData<Integer>(6,  (Integer) 4));
        segments.add(new Data.RangeSumData<Integer>(7,  (Integer) 5));
        segments.add(new Data.RangeSumData<Integer>(8,  (Integer) 6));
        segments.add(new Data.RangeSumData<Integer>(9,  (Integer) 7));
        segments.add(new Data.RangeSumData<Integer>(10, (Integer) 8));
        segments.add(new Data.RangeSumData<Integer>(11, (Integer) 9));
    ...
    private void testRangeSumFenwickTree2(List<Data.RangeSumData<Integer>> segments) {   // Range Sum Segment tree
        FenwickTree<Data.RangeSumData<Integer>> tree = new FenwickTree<Data.RangeSumData<Integer>>(segments);
    ...
    private static final <D extends Data> void assertTrue(String msg, FenwickTree<D> obj, boolean isTrue) {
        String toString = "";
        if (isTrue==false)
            toString = "\n"+obj.toString();
