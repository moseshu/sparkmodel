...
public class SegmentTreeTests {
    ...
    public void testQuadrantSegmentTree() {
        List<Data.QuadrantData> segments = new ArrayList<Data.QuadrantData>();
    ...
    private void testQuadrantSegmentTree(List<Data.QuadrantData> segments) {   // Quadrant Segment tree
    ...
    public void testRangeMaxSegmentTree() {
        List<Data.RangeMaximumData<Integer>> segments = new ArrayList<Data.RangeMaximumData<Integer>>();
    ...
    private void testRangeMaxSegmentTree(List<Data.RangeMaximumData<Integer>> segments) {   // Range Maximum Segment tree
    ...
    public void testRangeMinSegmentTree() {
        List<Data.RangeMinimumData<Integer>> segments = new ArrayList<Data.RangeMinimumData<Integer>>();
    ...
    private void testRangeMinSegmentTree(List<Data.RangeMinimumData<Integer>> segments) {   // Range Minimum Segment tree
    ...
    private void testRangeSumSegmentTree(List<Data.RangeSumData<Integer>> segments) {   // Range Sum Segment tree
    ...
    public void testLifespanSegmentTree() {
        List<Data.IntervalData<String>> segments = new ArrayList<Data.IntervalData<String>>();
    ...
    private void testLifespanSegmentTree(List<Data.IntervalData<String>> segments) {   // Lifespan Interval Segment tree
    ...
    private void testIntervalSegmentTree(List<Data.IntervalData<String>> segments) {   // Interval Segment tree
