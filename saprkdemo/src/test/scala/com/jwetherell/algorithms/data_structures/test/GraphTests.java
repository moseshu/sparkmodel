...
public class GraphTests {
    ...
    public void testCostPathPair() {
        final List<Edge<Integer>> s1 = new ArrayList<Edge<Integer>>(3);
        ...
        final List<Edge<Integer>> s2 = new ArrayList<Edge<Integer>>(3);
        ...
        final List<Edge<Integer>> s3 = new ArrayList<Edge<Integer>>(3);
